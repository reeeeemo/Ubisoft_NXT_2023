...
namespace App
{
	...
	void DrawLine( float sx, float sy, float ex, float ey, float r = 1.0f, float g = 1.0f, float b = 1.0f );
	//-------------------------------------------------------------------------------------------
	// Draw a 3D Quad from sx,sy,sz to ex,ey,ez to cx,cy,cz to px,py,pz using color r = red, g = green, b  = blue.
	//-------------------------------------------------------------------------------------------
	void DrawQuad(float sx, float sy, float sz, float ex, float ey, float ez, float cx, float cy, float cz, float px, float py, float pz, float r = 1.0f, float g = 1.0f, float b = 1.0f);
